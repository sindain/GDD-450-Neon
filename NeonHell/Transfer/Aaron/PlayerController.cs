...
//      break;
  ...
  void OnCollisionEnter(Collision collision){
    ...
    case "Wall":
      ...
      break;
    case "Player":
      NetPlayer _ColNetPlayer = collision.gameObject.GetComponent<NetPlayer> ();
      if (_ColNetPlayer.hasFlag ()){
        _ColNetPlayer.CmdToggleFlag ();
        GetComponent<NetPlayer> ().CmdToggleFlag ();
      }
      break;
    default:
      break;
