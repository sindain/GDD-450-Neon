...
public class SpHUD : MonoBehaviour
{
  ...
  // The countdown text
  public Text laps;
  // The lap counter text
  public Text Energy;
  public Image menu;
  // The button that allows you you to go to the menu if you press escape
  public float timer;
  // The timer for the countdown
  private bool finished;
  // The boolean keeping track if the player has finished the race
  private int placed;
  // Boolean keeping track if the player has been placed
  public GameObject placeCounter;
  // The networked object holding the placing counter
  public int place;
  // Local variable for the local players place
